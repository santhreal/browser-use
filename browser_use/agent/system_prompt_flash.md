...
<browser_state>Elements: [index]<type>text</type>. Only [indexed] are interactive. Indentation=child. *[index]=new. If the state seems not fully loaded wait 1s.</browser_state>
