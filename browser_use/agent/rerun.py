...
from browser_use.agent.views import ActionResult, AgentHistory, AgentHistoryList, RerunSummaryAction
...
class AgentRerunMixin:
	...
	task: str
	state: Any
	AgentOutput: type[Any]
	close: Callable[[], Awaitable[None]]
	multi_act: Callable[[list[ActionModel]], Awaitable[list[ActionResult]]]
	_substitute_variables_in_history: Callable[[AgentHistoryList, dict[str, str]], AgentHistoryList]
