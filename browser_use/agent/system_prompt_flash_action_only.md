...
6. <previous_memory>: Your reasoning and memory from the previous step (if available).
</input>
...
<action_focus>
Your task in this call is to determine the IMMEDIATE NEXT ACTIONS based on:
- The current browser state
- Your previous memory (if provided)
- The user request
