...
class ToolMessage(_MessageBase):
	...
	"""The role of the message author, in this case a tool result."""

	content: str
	"""The textual tool result content returned to the model."""

	tool_call_id: str
	"""The ID of the assistant tool call this result responds to."""

	name: str | None = None
	"""Optional tool name for providers that accept it."""
	...
	def __str__(self) -> str:
		return f'ToolMessage(tool_call_id={self.tool_call_id}, content={_truncate(self.content)})'

	def __repr__(self) -> str:
		return f'ToolMessage(tool_call_id={self.tool_call_id!r}, content={_truncate(repr(self.content), 50)})'


BaseMessage = Union[UserMessage, SystemMessage, AssistantMessage, ToolMessage]
