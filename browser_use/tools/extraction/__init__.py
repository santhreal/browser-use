from browser_use.tools.extraction.dedup import ResultDeduplicator, _canonical_hash
...
__all__ = ['schema_dict_to_pydantic_model', 'ExtractionResult', 'js_codegen_extract', '_is_empty_result', '_normalize_url_for_cache', 'ScriptCache', 'ResultDeduplicator', '_canonical_hash']
